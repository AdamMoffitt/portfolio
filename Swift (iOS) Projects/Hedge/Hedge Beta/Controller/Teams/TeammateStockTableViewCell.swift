//
//  TeammateStockTableViewCell.swift
//  Hedge Beta
//
//  Created by Jordan Coppert on 4/29/18.
//  Copyright © 2018 Adam's Apps. All rights reserved.
//

import UIKit

class TeammateStockTableViewCell: UITableViewCell {
    ...
    func createValueLabel(){
        valueLabel = UILabel()
        let str = String(format: "%.2f%%", change)
        valueLabel.text = str
    ...
    func setupViews(ticker: String, change: Float, companyName: String, username: String){
